                ...
                <div class="col-md-12">
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            <div class="col-md-12">
                                <?php echo form_open('subkriteria/add'); ?>
                                <div class="box-body">
                                    <div class="row clearfix">
                                        <div class="col-md-6">
                                            <label for="id_kriteria" class="control-label">
                                                <span class="text-danger">*</span> Kriteria
                                            </label>
                                            <div class="form-group">
                                                <select name="id_kriteria" class="form-control" id="id_kriteria">
                                                    ...
                                                    foreach ($all_kriteria as $kriteria) {
                                                        $selected = ($kriteria['id'] == $this->input->post('id_kriteria')) ? ' selected="selected"' : "";
                                        ...
                                        <div class="col-md-6">
                                            <label for="nama_subkriteria" class="control-label">
                                                <span class="text-danger">*</span> Nama Subkriteria
                                            </label>
                                            <div class="form-group">
                                                <input type="text" name="nama_subkriteria" value="<?php echo $this->input->post('nama_subkriteria'); ?>" class="form-control" id="nama_subkriteria" />
                                                <span class="text-danger"><?php echo form_error('nama_subkriteria'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="nilai" class="control-label">
                                                <span class="text-danger">*</span> Nilai
                                            </label>
                                            <div class="form-group">

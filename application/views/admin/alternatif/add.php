        ...
        <div class="col-md-12">
          ...
          <div class="ibox">
            ...
            <div class="ibox-content">
              <?php echo form_open('alternatif/add'); ?>
              <div class="row">
                <div class="col-md-6">
                  <label for="nis" class="control-label"><span class="text-danger">*</span>No Registrasi</label>
                  <div class="form-group">
                    <input type="number" name="nis" value="<?= $nis_faker ?>" class="form-control" id="nis" readonly/>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="nama_siswa" value="<?php echo $this->input->post('nama_siswa'); ?>" class="form-control" id="nama_siswa" />
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <input type="text" name="jenis_kelamin" value="<?php echo $this->input->post('jenis_kelamin'); ?>" class="form-control" id="banjar" />

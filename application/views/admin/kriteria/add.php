                  ...
                  <div class="row clearfix">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <input type="text" name="nama_kriteria" value="<?php echo $this->input->post('nama_kriteria'); ?>" class="form-control" id="nama_kriteria" />
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <input type="number" name="bobot" value="<?php echo $this->input->post('bobot'); ?>" class="form-control" id="bobot" />
